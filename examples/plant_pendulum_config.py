...
state = PlantPendulum(upd_freq_hz=200) # should be 200
controller_interface = UDPControllerInterface

sensors = [
    SimpleSensor('position', 100), # should be 100
    SimpleSensor('speed', 100), # should be 100
    SimpleSensor('angle', 100), # should be 100
    SimpleSensor('ang_vel', 100),# should be 100
]
